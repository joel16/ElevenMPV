...
static void Menu_DisplayDeviceSettings(void) {
	...
	while (SCE_TRUE) {
        ...
        vita2d_pvf_draw_text(font, 102, 27 + ((72 - vita2d_pvf_text_height(font, 1, "Device")) / 2) + 20, RGBA8(255, 255, 255, 255), 1, "Device");
		...
		vita2d_draw_texture(config.device == 5 ? radio_on : radio_off, 850, 486);
...
static void Menu_DisplaySortSettings(void) {
	...
	while (SCE_TRUE) {
		...
		vita2d_draw_texture(icon_back, BTN_BACK_X, BTN_TOPBAR_Y);
		vita2d_pvf_draw_text(font, 102, 27 + ((72 - vita2d_pvf_text_height(font, 1, "Sort")) / 2) + 20, RGBA8(255, 255, 255, 255), 1, "Sort");
...
static void Menu_DisplayAudioSettings(void) {
	...
	while (SCE_TRUE) {
		...
		vita2d_draw_texture(icon_back, BTN_BACK_X, BTN_TOPBAR_Y);
		vita2d_pvf_draw_text(font, 102, 27 + ((72 - vita2d_pvf_text_height(font, 1, "Audio")) / 2) + 20, RGBA8(255, 255, 255, 255), 1, "Audio");
...
static void Menu_DisplayControlsSettings(void) {
	int selection = 0, max_items = 3, type = 0;
	...
	const char *menu_items[] = {
		"Skip Tracks With Right Stick (Sleep Mode)",
		"Motion Controls",
		"Timeout                                                                                                         %s sec",
		"Angle Threshold                                                                                             %s deg"
	};
	...
	while (SCE_TRUE) {
		...
		vita2d_draw_texture(icon_back, BTN_BACK_X, BTN_TOPBAR_Y);
		vita2d_pvf_draw_text(font, 102, 27 + ((72 - vita2d_pvf_text_height(font, 1, "Controls")) / 2) + 20, RGBA8(255, 255, 255, 255), 1, "Controls");
		...
		if (!ime_active) {
			...
			vita2d_draw_texture(config.stick_skip == SCE_TRUE ? toggle_on : toggle_off, 850, 118);
			vita2d_draw_texture(config.motion_mode == SCE_TRUE ? toggle_on : toggle_off, 850, 190);
		}
		else {
			vita2d_draw_rectangle(0, 112 + (72 * printed), 960, 72, RGBA8(230, 230, 230, 255));
			switch (selection) {
			case 2:
				vita2d_pvf_draw_textf(font, 30, 120 + (72 / 2) + (72 * printed), RGBA8(51, 51, 51, 255), 1, menu_items[2], motion_timer_outval);
				break;
			case 3:
				vita2d_pvf_draw_textf(font, 30, 120 + (72 / 2) + (72 * printed), RGBA8(51, 51, 51, 255), 1, menu_items[3], motion_degree_outval_utf8);
				break;
			}
		}
		...
		if (!ime_active) {
			...
			if (pressed & SCE_CTRL_ENTER) {
				switch (selection) {
				case 0:
					config.stick_skip = !config.stick_skip;
					break;
				case 1:
...
static void Menu_DisplayPowerSettings(void) {
	...
	while (SCE_TRUE) {
		...
		vita2d_draw_texture(icon_back, BTN_BACK_X, BTN_TOPBAR_Y);
		vita2d_pvf_draw_text(font, 102, 27 + ((72 - vita2d_pvf_text_height(font, 1, "Power Saving")) / 2) + 20, RGBA8(255, 255, 255, 255), 1, "Power Saving");
...
static void Menu_DisplaySystemSettings(void) {
	...
	while (SCE_TRUE) {
		...
		vita2d_draw_texture(icon_back, BTN_BACK_X, BTN_TOPBAR_Y);
		vita2d_pvf_draw_text(font, 102, 27 + ((72 - vita2d_pvf_text_height(font, 1, "Notifications")) / 2) + 20, RGBA8(255, 255, 255, 255), 1, "Notifications");
...
void Menu_DisplaySettings(void) {
	...
	while (SCE_TRUE) {
		...
		vita2d_draw_texture(icon_back, BTN_BACK_X, BTN_TOPBAR_Y);
		vita2d_pvf_draw_text(font, 102, 27 + ((72 - vita2d_pvf_text_height(font, 1, "Settings")) / 2) + 20, RGBA8(255, 255, 255, 255), 1, "Settings");
